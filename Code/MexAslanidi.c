...
/* Mex Function*/
static void MexAslanidi(N_Vector ydot, realtype t, N_Vector y, double* pr, double* T, double* Y0, int M, double* yout) {
...
if (protocol_number==20){
    ...
    const double tau_y1 = (P1/(1+exp(v*P2)))+P3;
    const double y1_inf =1/(1+P4*exp(-P5*v));
        ...
        
{
    ...
    /* Mex function call */
    MexAslanidi(ydot, t, y, pr, T, Y0, M, yout);
    return;
