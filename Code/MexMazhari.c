...
/* Mex Function*/
static void MexMazhari(N_Vector ydot, realtype t, N_Vector y, double* pr, double* T, double* Y0, int M, double* yout) {
...
static int f(realtype t, N_Vector y, N_Vector ydot, void* pr0) {
    ...
    const double k24 = P14*exp((P15*v));
    
    phi = (k32*k24*k43)/(k34*k23);
        ...
        
{
    ...
    /* Mex function call */
    MexMazhari(ydot, t, y, pr, T, Y0, M, yout);
    return;
