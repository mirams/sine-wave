...
/* Mex Function*/
static void MexLiu(N_Vector ydot, realtype t, N_Vector y, double* pr, double* T, double* Y0, int M, double* yout) {
        ...
        
{
    ...
    /* Mex function call */
    MexLiu(ydot, t, y, pr, T, Y0, M, yout);
    return;
