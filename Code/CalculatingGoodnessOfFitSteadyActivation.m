function CalculatingGoodnessOfFitSteadyActivation(exp_ref)

% Compares predictions of current response to steady-state activation protocol for experiment exp_ref
...
% Imports steady-state activation, sine wave and action potential protocols
...
I=SimulatingData(35,{'steady_activation'},k,V,temperature);
I_av=SimulatingData(35,{'steady_activation'},k_av,V,temperature);
...
JJM = IM;
JJD = ID;
% Calculate square differences between cell-specific, average and literature models and steady state activation experimental data trace
