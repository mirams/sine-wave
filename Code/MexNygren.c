...
/* Mex Function*/
static void MexNygren(N_Vector ydot, realtype t, N_Vector y, double* pr, double* T, double* Y0, int M, double* yout) {
...
static int f(realtype t, N_Vector y, N_Vector ydot, void* pr0) {
    ...
    const double tau_y1 = P3 + P4*exp(-(P6*v*v)-P5*v);
        ...
        
{
    ...
    /* Mex function call */
    MexNygren(ydot, t, y, pr, T, Y0, M, yout);
    return;
