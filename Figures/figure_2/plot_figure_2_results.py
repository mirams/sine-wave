...
voltage_file = 'figure_2_data/figure_2_sine_wave_protocol.txt'
...
experiment_file = 'figure_2_data/figure_2_sine_wave_experimental_data.txt'
#file = open(experiment_file, 'r')
data = numpy.loadtxt(experiment_file, skiprows=0)
experimental_currents = data[:,1:]

current_file ='figure_2_data/figure_2_sine_wave_model_data.txt'
...
left_shift_for_panel_labels = -0.16
...
plt.savefig('figure_2.pdf', bbox_inches='tight', dpi=900, pad_inches=0.05)
