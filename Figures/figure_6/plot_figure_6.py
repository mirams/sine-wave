...
average_file = 'steady_activation_peak_current_figure_6_b/average_cell_steady_activation_peak_sim.txt'
...
for i in range(0,num_cells):
    ...
    experiment_file = 'steady_activation_peak_current_figure_6_b/cell_' + str(i+1) + '_steady_activation_peak_exp.txt'
    exp_data[i,:,:] = np.loadtxt(experiment_file, skiprows=0)
    
    simulation_file = 'steady_activation_peak_current_figure_6_b/cell_' + str(i+1) + '_steady_activation_peak_sim.txt'
